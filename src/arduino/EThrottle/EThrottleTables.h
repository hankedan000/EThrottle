...
#define TABLE_SIZE_CFG_PAGE1 64 
#define TABLE_SIZE_CFG_PAGE2 7  
#define TABLE_FLASH_OFFSET_CFG_PAGE1 (MEGA_CAN_EXT_MAX_FLASH_TABLE_SIZE * 0)
#define TABLE_FLASH_OFFSET_CFG_PAGE2 (MEGA_CAN_EXT_MAX_FLASH_TABLE_SIZE * 1)
...
static_assert(sizeof(Page1_T) == 64);
...
static_assert(sizeof(Page2_T) == 7);
